...
import { Settings, Star, PenTool, Mic as MicIcon, Guitar, Zap, Disc, ArrowRight } from 'lucide-react';
import { Role } from '../types';

const DEFAULT_PLAYER_NAME = "七濑舞禾";

interface WelcomeScreenProps {
    onStartGame: (role: Role, name: string) => void;
    onOpenSettings: () => void;
}

export const WelcomeScreen = ({ onStartGame, onOpenSettings }: WelcomeScreenProps) => {
                ...
                <div className="flex-1 space-y-8 relative z-10 text-center md:text-left w-full">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-6xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9] italic">
                            GIRLS'<br/>
                            <span className="text-rose-500">BAND</span> SIM
                        </h1>
