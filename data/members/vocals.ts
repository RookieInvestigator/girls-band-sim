...
export const VOCALS: Member[] = [
  // --- New Recruits (Assigned to Vocal) ---
  {
      ...
      musicality: 60, technique: 40, stagePresence: 75, creativity: 50, mental: 65,
      fatigue: 0, stress: 20, affection: 30, personality: '自尊心极高的大小姐，认为自己生来就是为了站在聚光灯下。',
      tags: ['完美主义', '大小姐'], interactionsLeft: 2, composing: 30, lyrics: 50, arrangement: 20, design: 60,
  ...
  },
  {
      ...
      musicality: 45, technique: 35, stagePresence: 50, creativity: 30, mental: 45,
      fatigue: 0, stress: 10, affection: 70, personality: '虽然没有突出的才能，但比任何人都努力的普通女高中生。',
      tags: ['练习狂', '凡人'], interactionsLeft: 2, composing: 20, lyrics: 30, arrangement: 20, design: 20,
  ...
  },
  {
      ...
      musicality: 55, technique: 30, stagePresence: 40, creativity: 60, mental: 10,
      fatigue: 0, stress: 50, affection: 40, personality: '仿佛随时会消失的透明感少女，写出的歌词充满了悲伤。',
      tags: ['玻璃心', '文学少女'], interactionsLeft: 2, composing: 20, lyrics: 75, arrangement: 10, design: 20,
  ...
  },
  {
      ...
      musicality: 75, technique: 65, stagePresence: 40, creativity: 30, mental: 30,
      fatigue: 0, stress: 40, affection: 10, personality: '声乐科第一名，认为摇滚是“粗俗的噪音”但为了反抗父母而加入。',
      tags: ['古典', '傲娇', '大小姐'], interactionsLeft: 2, composing: 40, lyrics: 10, arrangement: 60, design: 30,
  ...
  { 
    ...
    musicality: 40, technique: 30, stagePresence: 60, creativity: 30, mental: 50, 
    fatigue: 0, stress: 10, affection: 50, personality: '正统派的主人公性格，为了帅气地弹唱而正在苦练吉他。', 
    tags: ['努力家', '青春'], interactionsLeft: 2, 
    composing: 20, lyrics: 40, arrangement: 10, design: 20, 
  ...
  { 
    ...
    musicality: 50, technique: 40, stagePresence: 70, creativity: 20, mental: 30, 
    fatigue: 0, stress: 20, affection: 30, personality: '前地下偶像Center，因为想做“真正的音乐”而退团，自尊心很高。', 
    tags: ['前偶像', '傲娇'], interactionsLeft: 2, 
    composing: 10, lyrics: 30, arrangement: 10, design: 60, 
  ...
  { 
    ...
    musicality: 30, technique: 20, stagePresence: 75, creativity: 30, mental: 70, 
    fatigue: 0, stress: 0, affection: 60, personality: '每天都要喝珍珠奶茶的辣妹，虽然音准一般但现场煽动力满分。', 
    tags: ['辣妹', '现充'], interactionsLeft: 2, 
    composing: 10, lyrics: 20, arrangement: 5, design: 70, 
  ...
  { 
    ...
    musicality: 45, technique: 35, stagePresence: 30, creativity: 65, mental: 10, 
    fatigue: 0, stress: 40, affection: 40, personality: '总是躲在图书馆的文学少女，写出的歌词充满了毁灭的美感。', 
    tags: ['文学少女', '内向'], interactionsLeft: 2, 
    composing: 30, lyrics: 75, arrangement: 10, design: 20, 
  ...
  { 
    ...
    musicality: 40, technique: 30, stagePresence: 65, creativity: 30, mental: 60, 
    fatigue: 0, stress: 10, affection: 30, personality: '不良少女的领袖，嗓音沙哑有爆发力，意外地很讲义气。', 
    tags: ['不良', '大姐头'], interactionsLeft: 2, 
    composing: 10, lyrics: 40, arrangement: 10, design: 10, 
  ...
  { 
    ...
    musicality: 60, technique: 50, stagePresence: 30, creativity: 40, mental: 20, 
    fatigue: 0, stress: 20, affection: 40, personality: '在网络上拥有一百万粉丝的神秘翻唱歌手，现实中却极度怕生。', 
    tags: ['社恐', '网络歌手'], interactionsLeft: 2, 
    composing: 30, lyrics: 30, arrangement: 40, design: 40, 
  ...
  { 
    ...
    musicality: 40, technique: 30, stagePresence: 50, creativity: 35, mental: 40, 
    fatigue: 0, stress: 10, affection: 60, personality: '为了在文化祭上追随憧憬的前辈而组建乐队的追梦少女。', 
    tags: ['憧憬', '普通人'], interactionsLeft: 2, 
    composing: 20, lyrics: 60, arrangement: 10, design: 20, 
  ...
  { 
    ...
    musicality: 50, technique: 45, stagePresence: 40, creativity: 40, mental: 30, 
    fatigue: 0, stress: 30, affection: 50, personality: '贝斯手出身的主唱，喜欢低沉的旋律，性格有些阴郁。', 
    tags: ['消极', '稳重'], interactionsLeft: 2, 
    composing: 30, lyrics: 50, arrangement: 20, design: 10, 
  ...
  { 
    ...
    musicality: 65, technique: 60, stagePresence: 55, creativity: 40, mental: 40, 
    fatigue: 0, stress: 20, affection: 20, personality: '出生于音乐世家的小提琴首席，为了反抗家族而开始唱摇滚。', 
    tags: ['古典', '叛逆'], interactionsLeft: 2, 
    composing: 40, lyrics: 20, arrangement: 50, design: 30, 
  ...
  { 
    ...
    musicality: 35, technique: 30, stagePresence: 70, creativity: 20, mental: 60, 
    fatigue: 0, stress: 0, affection: 40, personality: '关西来的转学生，比起唱歌更喜欢在MC环节讲相声。', 
    tags: ['搞笑艺人', '乐天派'], interactionsLeft: 2, 
    composing: 10, lyrics: 20, arrangement: 10, design: 10, 
