...
export const LEGENDARY_MEMBERS: Member[] = [
  { 
    ...
    musicality: 65, technique: 30, stagePresence: 45, creativity: 80, mental: 10, 
  ...
  { 
    ...
    musicality: 70, technique: 70, stagePresence: 60, creativity: 65, mental: 60, 
    ...
    interactionsLeft: 2, 
    composing: 75, lyrics: 50, arrangement: 70, design: 60,
  ...
  { 
    ...
    musicality: 60, technique: 78, stagePresence: 10, creativity: 40, mental: 5, 
    ...
    interactionsLeft: 2, 
    composing: 40, lyrics: 20, arrangement: 50, design: 10,
  ...
  { 
    ...
    musicality: 55, technique: 50, stagePresence: 65, creativity: 40, mental: 75, 
    ...
    interactionsLeft: 2, 
    composing: 20, lyrics: 30, arrangement: 40, design: 50,
  ...
  { 
    ...
    musicality: 75, technique: 65, stagePresence: 70, creativity: 70, mental: 40, 
    ...
    interactionsLeft: 2, 
    composing: 75, lyrics: 60, arrangement: 70, design: 40,
  ...
  { 
    ...
    musicality: 40, technique: 35, stagePresence: 70, creativity: 40, mental: 60, 
    ...
    interactionsLeft: 2, 
    composing: 20, lyrics: 30, arrangement: 10, design: 50,
  ...
  { 
    ...
    musicality: 65, technique: 75, stagePresence: 40, creativity: 40, mental: 50, 
  ...
  { 
    ...
    musicality: 75, technique: 40, stagePresence: 75, creativity: 50, mental: 60, 
    fatigue: 0, stress: 0, affection: 60, 
    personality: '完全不懂乐理却能写出神曲的天才少女，靠直觉活着的生物。', 
    netaDesc: '拥有绝对音感的天然呆，认为吉他只要有爱就能弹好。放学后Tea Time的主音吉他手。',
    tags: ['自由人', '天才', '天然呆'], // Unique: 自由人
    interactionsLeft: 2, 
    composing: 60, lyrics: 30, arrangement: 10, design: 30, 
  ...
  { 
    ...
    musicality: 70, technique: 70, stagePresence: 40, creativity: 65, mental: 40, 
    ...
    interactionsLeft: 2, 
    composing: 50, lyrics: 40, arrangement: 70, design: 40, 
  ...
  { 
    ...
    musicality: 65, technique: 75, stagePresence: 70, creativity: 60, mental: 50, 
    ...
    interactionsLeft: 2, 
    composing: 60, lyrics: 50, arrangement: 65, design: 40, 
