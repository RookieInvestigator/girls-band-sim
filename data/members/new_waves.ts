...
export const NEW_WAVES: Member[] = [
  ...
  
  {
      ...
      musicality: 65, technique: 70, stagePresence: 55, creativity: 50, mental: 40,
      fatigue: 0, stress: 30, affection: 20, personality: '总是戴着狐狸面具的三味线乐手，试图将传统乐器融入重金属。',
      tags: ['和风', '神秘', '前卫'], interactionsLeft: 2, composing: 45, lyrics: 20, arrangement: 60, design: 70,
  ...
  },
  {
      ...
      musicality: 70, technique: 65, stagePresence: 60, creativity: 40, mental: 30,
      fatigue: 0, stress: 10, affection: 10, personality: '把昂贵的竖琴搬进LiveHouse的真正贵族，对平民生活一无所知。',
      tags: ['贵族', '天然', '治愈'], interactionsLeft: 2, composing: 55, lyrics: 15, arrangement: 45, design: 75,
  ...
  },
  {
      ...
      musicality: 60, technique: 55, stagePresence: 70, creativity: 65, mental: 75,
      fatigue: 0, stress: 0, affection: 60, personality: '背着手风琴环游世界的流浪艺人，只要有风的地方就是舞台。',
      tags: ['吟游诗人', '随性', '体力怪物'], interactionsLeft: 2, composing: 60, lyrics: 60, arrangement: 35, design: 30,
  ...
  },
  {
      ...
      musicality: 45, technique: 55, stagePresence: 75, creativity: 60, mental: 65,
      fatigue: 0, stress: 20, affection: 30, personality: '眼神凶恶的地下MC，歌词像机关枪一样辛辣，讨厌虚伪的大人。',
      tags: ['街头', '毒舌', '真实'], interactionsLeft: 2, composing: 35, lyrics: 80, arrangement: 30, design: 55,
  ...
  },
  {
      ...
      musicality: 55, technique: 45, stagePresence: 35, creativity: 80, mental: 20,
      fatigue: 0, stress: 40, affection: 20, personality: '自称能接收宇宙信号的特雷门琴演奏者，总是对着空气挥手。',
      tags: ['电波', '未来人', '技术宅'], interactionsLeft: 2, composing: 75, lyrics: 10, arrangement: 70, design: 40,
  ...
  },
  {
      ...
      musicality: 60, technique: 75, stagePresence: 45, creativity: 35, mental: 60,
      fatigue: 0, stress: 10, affection: 30, personality: '传统艺能世家的继承人，性格古板严厉，认为练习必须一丝不苟。',
      tags: ['和风', '完美主义'], interactionsLeft: 2, composing: 30, lyrics: 30, arrangement: 55, design: 45,
  ...
  },
  {
      ...
      musicality: 55, technique: 50, stagePresence: 65, creativity: 70, mental: 45,
      fatigue: 0, stress: 20, affection: 50, personality: '戴着眼镜的文学社社长，一旦拿起麦克风就会变成饶舌机关枪。',
      tags: ['文学少女', '街头'], interactionsLeft: 2, composing: 45, lyrics: 80, arrangement: 20, design: 30,
  ...
  },
  {
      ...
      musicality: 55, technique: 55, stagePresence: 70, creativity: 45, mental: 65,
      fatigue: 0, stress: 0, affection: 70, personality: '总是在公园长椅上演奏手风琴的元气少女，吸引了很多小孩子。',
      tags: ['街头', '元气'], interactionsLeft: 2, composing: 35, lyrics: 30, arrangement: 45, design: 35,
  ...
  },
  {
      ...
      musicality: 65, technique: 60, stagePresence: 35, creativity: 45, mental: 70,
      fatigue: 0, stress: 0, affection: 40, personality: '神社的巫女，声称竖琴的音色可以净化邪念。',
      tags: ['治愈', '神圣'], interactionsLeft: 2, composing: 45, lyrics: 20, arrangement: 35, design: 55,
