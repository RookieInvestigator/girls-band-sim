...
export const GUITARS: Member[] = [
  // --- New Recruits (Assigned to Guitar) ---
  {
      ...
      musicality: 45, technique: 65, stagePresence: 30, creativity: 55, mental: 40,
      fatigue: 0, stress: 10, affection: 40, personality: '把吉他当成手柄操作的游戏宅，追求AP（All Perfect）的演奏。',
      tags: ['网游废人', '技术流'], interactionsLeft: 2, composing: 60, lyrics: 20, arrangement: 40, design: 10,
  ...
  },
  {
      ...
      musicality: 50, technique: 70, stagePresence: 55, creativity: 40, mental: 50,
      fatigue: 0, stress: 40, affection: 20, personality: '总是独来独往的冷酷吉他手，追求极致的速度。',
      tags: ['酷', '技术流'], interactionsLeft: 2, composing: 40, lyrics: 10, arrangement: 30, design: 20,
  ...
  },
  {
      ...
      musicality: 50, technique: 50, stagePresence: 30, creativity: 70, mental: 40,
      fatigue: 0, stress: 20, affection: 30, personality: '喜欢蒸汽朋克风格的发明家，吉他上装满了奇怪的齿轮和仪表。',
      tags: ['怪人', '技术宅'], interactionsLeft: 2, composing: 60, lyrics: 20, arrangement: 65, design: 50,
  ...
  },
  {
      ...
      musicality: 30, technique: 45, stagePresence: 70, creativity: 30, mental: 60,
      fatigue: 0, stress: 30, affection: 20, personality: '眼神凶恶的朋克少女，弹琴时像是在用吉他打架，经常弄坏设备。',
      tags: ['不良', '破坏神'], interactionsLeft: 2, composing: 20, lyrics: 20, arrangement: 10, design: 40,
  ...
  },
  {
      ...
      musicality: 45, technique: 40, stagePresence: 30, creativity: 50, mental: 70,
      fatigue: 0, stress: 0, affection: 90, personality: '手芸部部长，给乐队成员亲手制作了演出服和背带，像妈妈一样温柔。',
      tags: ['治愈', '设计'], interactionsLeft: 2, composing: 30, lyrics: 30, arrangement: 20, design: 75,
  ...
  { 
    ...
    musicality: 40, technique: 40, stagePresence: 35, creativity: 30, mental: 40, 
    fatigue: 0, stress: 10, affection: 70, personality: '想要成为唱作人的普通少女，正在努力学习边弹边唱。', 
    tags: ['凡人', '努力家'], interactionsLeft: 2, 
    composing: 30, lyrics: 30, arrangement: 20, design: 10, 
  ...
  { 
    ...
    musicality: 45, technique: 40, stagePresence: 50, creativity: 30, mental: 35, 
    fatigue: 0, stress: 20, affection: 30, personality: '用零花钱买了一整墙昂贵吉他的大小姐，认为音色也是实力的一部分。', 
    tags: ['大小姐', '器材党'], interactionsLeft: 2, 
    composing: 20, lyrics: 10, arrangement: 10, design: 40, 
  ...
  { 
    ...
    musicality: 30, technique: 25, stagePresence: 60, creativity: 15, mental: 70, 
  ...
  { 
    ...
    musicality: 35, technique: 45, stagePresence: 55, creativity: 30, mental: 20, 
    fatigue: 0, stress: 30, affection: 40, personality: '为了向前乐队的同伴复仇而开始玩乐器，结果意外地觉醒了才能。', 
    tags: ['傲娇', '复仇'], interactionsLeft: 2, 
    composing: 20, lyrics: 40, arrangement: 10, design: 30, 
  ...
  { 
    ...
    musicality: 45, technique: 45, stagePresence: 10, creativity: 50, mental: 30, 
    fatigue: 0, stress: 10, affection: 30, personality: '全程盯着脚下效果器的鞋式摇滚乐手，用噪音构筑音墙。', 
    tags: ['鞋式摇滚', '社恐'], interactionsLeft: 2, 
    composing: 40, lyrics: 10, arrangement: 50, design: 10, 
  ...
  { 
    ...
    musicality: 40, technique: 35, stagePresence: 70, creativity: 20, mental: 40, 
    fatigue: 0, stress: 20, affection: 40, personality: '兼职读者模特，把舞台当成T台，非常在意打光角度。', 
    tags: ['模特', '现充'], interactionsLeft: 2, 
    composing: 10, lyrics: 20, arrangement: 10, design: 60, 
  ...
  { 
    ...
    musicality: 55, technique: 60, stagePresence: 30, creativity: 35, mental: 50, 
    fatigue: 0, stress: 30, affection: 20, personality: '理科班的学霸，被称为“人体节拍器”，容不得半点抢拍或拖拍。', 
    tags: ['完美主义', '学霸'], interactionsLeft: 2, 
    composing: 30, lyrics: 10, arrangement: 40, design: 10, 
  ...
  { 
    ...
    musicality: 50, technique: 45, stagePresence: 20, creativity: 60, mental: 35, 
    fatigue: 0, stress: 10, affection: 30, personality: '擅长DTM（桌面音乐制作）的宅女，比起现场演奏更喜欢在电脑前编曲。', 
    tags: ['技术宅', '幕后'], interactionsLeft: 2, 
    composing: 60, lyrics: 30, arrangement: 65, design: 30, 
  ...
  { 
    ...
    musicality: 40, technique: 50, stagePresence: 45, creativity: 35, mental: 20, 
    fatigue: 0, stress: 20, affection: 40, personality: '平时是乖乖女，一上台就会画上烟熏妆释放压力的视觉系信徒。', 
    tags: ['视觉系', '反差萌'], interactionsLeft: 2, 
    composing: 30, lyrics: 30, arrangement: 35, design: 50, 
