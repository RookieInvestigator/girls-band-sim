...
export const BASSISTS: Member[] = [
  // --- New Recruits (Assigned to Bass) ---
  {
      ...
      musicality: 45, technique: 45, stagePresence: 35, creativity: 30, mental: 70,
      fatigue: 0, stress: 0, affection: 80, personality: '性格温和的治愈系，总是带着自制的便当，是乐队的稳定剂。',
      tags: ['可靠', '治愈'], interactionsLeft: 2, composing: 20, lyrics: 30, arrangement: 35, design: 20,
  ...
  },
  {
      ...
      musicality: 45, technique: 50, stagePresence: 65, creativity: 35, mental: 60,
      fatigue: 0, stress: 10, affection: 50, personality: '看起来是不良少女，其实很喜欢可爱的小动物和玩偶。',
      tags: ['反差萌', '不良'], interactionsLeft: 2, composing: 20, lyrics: 20, arrangement: 30, design: 50,
  ...
  },
  {
      ...
      musicality: 50, technique: 55, stagePresence: 30, creativity: 20, mental: 70,
      fatigue: 0, stress: 10, affection: 50, personality: '剑道部主将，性格古板认真，把贝斯当成盾牌来守护乐队。',
      tags: ['认真', '古板'], interactionsLeft: 2, composing: 15, lyrics: 20, arrangement: 30, design: 15,
  ...
  },
  {
      ...
      musicality: 45, technique: 65, stagePresence: 70, creativity: 30, mental: 65,
      fatigue: 0, stress: 20, affection: 40, personality: '使用六弦贝斯的重金属狂热者，喜欢甩头和踩监听音箱。',
      tags: ['大姐头', '体力怪物'], interactionsLeft: 2, composing: 30, lyrics: 20, arrangement: 40, design: 35,
  ...
  },
  {
      ...
      musicality: 55, technique: 55, stagePresence: 20, creativity: 35, mental: 50,
      fatigue: 0, stress: 10, affection: 30, personality: '总是含着薄荷糖的无口少女，演奏出的贝斯线像冰一样冷静。',
      tags: ['三无', '学霸'], interactionsLeft: 2, composing: 40, lyrics: 15, arrangement: 45, design: 20,
  ...
  { 
    ...
    musicality: 40, technique: 35, stagePresence: 30, creativity: 20, mental: 60, 
    fatigue: 0, stress: 10, affection: 70, personality: '总是带着急救包和零食，乐队里的老妈子担当，负责调解吵架。', 
    tags: ['妈妈', '可靠'], interactionsLeft: 2, 
    composing: 15, lyrics: 15, arrangement: 30, design: 20, 
  ...
  { 
    ...
    musicality: 50, technique: 45, stagePresence: 50, creativity: 30, mental: 45, 
    fatigue: 0, stress: 20, affection: 30, personality: '身高175cm的冰山美人，虽然不爱说话但和声非常完美。', 
    tags: ['高冷', '三无'], interactionsLeft: 2, 
    composing: 20, lyrics: 20, arrangement: 35, design: 30, 
  ...
  { 
    ...
    musicality: 35, technique: 30, stagePresence: 45, creativity: 20, mental: 30, 
    fatigue: 0, stress: 10, affection: 60, personality: '个子很小却背着巨大的贝斯，经常被误认为是初中生。', 
    tags: ['萝莉', '吉祥物'], interactionsLeft: 2, 
    composing: 10, lyrics: 15, arrangement: 10, design: 40, 
  ...
  { 
    ...
    musicality: 55, technique: 50, stagePresence: 60, creativity: 35, mental: 40, 
  ...
  { 
    ...
    musicality: 55, technique: 50, stagePresence: 60, creativity: 45, mental: 40, 
    fatigue: 0, stress: 10, affection: 30, personality: '“吾之低音乃深渊的咆哮...” 沉迷哥特萝莉装扮的中二少女。', 
    tags: ['中二病', '视觉系'], interactionsLeft: 2, 
    composing: 40, lyrics: 50, arrangement: 30, design: 50, 
  ...
  { 
    ...
    musicality: 45, technique: 55, stagePresence: 35, creativity: 35, mental: 45, 
    fatigue: 0, stress: 20, affection: 40, personality: '原本想弹吉他但是猜拳输了，结果意外觉醒了Slap天赋。', 
    tags: ['天才', '随性'], interactionsLeft: 2, 
    composing: 20, lyrics: 15, arrangement: 45, design: 15, 
  ...
  { 
    ...
    musicality: 35, technique: 35, stagePresence: 10, creativity: 15, mental: 70, 
    fatigue: 0, stress: 0, affection: 50, personality: '存在感极低，经常被自动门忽视，但节奏稳如泰山。', 
    tags: ['路人', '稳重'], interactionsLeft: 2, 
    composing: 10, lyrics: 10, arrangement: 30, design: 10, 
  ...
  { 
    ...
    musicality: 30, technique: 30, stagePresence: 55, creativity: 20, mental: 40, 
