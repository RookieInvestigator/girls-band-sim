...
export const KEYBOARDS: Member[] = [
  // --- New Recruits (Assigned to Keyboard) ---
  {
      ...
      musicality: 55, technique: 50, stagePresence: 45, creativity: 70, mental: 30,
      fatigue: 0, stress: 30, affection: 20, personality: '自称来自仙女座的电波系少女，随身携带星图。',
      tags: ['电波', '中二病'], interactionsLeft: 2, composing: 65, lyrics: 60, arrangement: 50, design: 45,
  ...
  },
  {
      ...
      musicality: 60, technique: 55, stagePresence: 30, creativity: 65, mental: 70,
      fatigue: 0, stress: 0, affection: 10, personality: '说话像AI一样没有抑扬顿挫的理科天才，喜欢观察人类。',
      tags: ['机器人', '天才'], interactionsLeft: 2, composing: 70, lyrics: 10, arrangement: 70, design: 40,
  ...
  },
  {
      ...
      musicality: 50, technique: 50, stagePresence: 35, creativity: 60, mental: 40,
      fatigue: 0, stress: 30, affection: 20, personality: '喜欢心理学和神秘学的短发少女，总是用塔罗牌决定当天的音色。',
      tags: ['神秘', '随性'], interactionsLeft: 2, composing: 45, lyrics: 45, arrangement: 50, design: 30,
  ...
  },
  {
      ...
      musicality: 55, technique: 45, stagePresence: 30, creativity: 65, mental: 40,
      fatigue: 0, stress: 20, affection: 30, personality: '典型的夜猫子，喜欢在凌晨两点写Synthwave，白天总是没精神。',
      tags: ['网游废人', '宅女'], interactionsLeft: 2, composing: 60, lyrics: 20, arrangement: 55, design: 45,
  ...
  },
  {
      ...
      musicality: 75, technique: 70, stagePresence: 25, creativity: 60, mental: 30,
      fatigue: 0, stress: 30, affection: 20, personality: '钢琴神童，因为讨厌看乐谱和练习枯燥的古典曲目而逃出来玩乐队。',
      tags: ['天才', '自由人'], interactionsLeft: 2, composing: 70, lyrics: 20, arrangement: 45, design: 20,
  ...
  { 
    ...
    musicality: 60, technique: 60, stagePresence: 45, creativity: 40, mental: 45, 
    fatigue: 0, stress: 30, affection: 20, personality: '学生会长，全能完美超人，但在庶民生活方面缺乏常识。', 
    tags: ['完美主义', '大小姐'], interactionsLeft: 2, 
    composing: 40, lyrics: 30, arrangement: 50, design: 30, 
  ...
  { 
    ...
    musicality: 55, technique: 55, stagePresence: 30, creativity: 45, mental: 40, 
    fatigue: 0, stress: 20, affection: 40, personality: '爵士钢琴教室长大的孩子，喜欢在流行曲子里加奇怪的减九和弦。', 
    tags: ['爵士', '随性'], interactionsLeft: 2, 
    composing: 35, lyrics: 15, arrangement: 55, design: 20, 
  ...
  { 
    ...
    musicality: 40, technique: 35, stagePresence: 20, creativity: 30, mental: 15, 
    fatigue: 0, stress: 40, affection: 60, personality: '在家里蹲了很久，通过网络直播接触到了外面的世界。', 
    tags: ['社恐', '家里蹲'], interactionsLeft: 2, 
    composing: 20, lyrics: 20, arrangement: 15, design: 30, 
  ...
  { 
    ...
    composing: 55, lyrics: 20, arrangement: 45, design: 40, 
  ...
  { 
    ...
    musicality: 35, technique: 35, stagePresence: 30, creativity: 30, mental: 60, 
    fatigue: 0, stress: 10, affection: 70, personality: '在个性的乐队里唯一的常识人，负责把大家拉回现实。', 
    tags: ['凡人', '吐槽役'], interactionsLeft: 2, 
    composing: 20, lyrics: 30, arrangement: 20, design: 30, 
  ...
  { 
    ...
    musicality: 55, technique: 50, stagePresence: 55, creativity: 60, mental: 45, 
    fatigue: 0, stress: 20, affection: 30, personality: '说话晦涩难懂的深度中二病，自称是被神选中的观测者。', 
    tags: ['中二病', '哲学'], interactionsLeft: 2, 
    composing: 45, lyrics: 60, arrangement: 40, design: 45, 
  ...
  { 
    ...
    musicality: 40, technique: 40, stagePresence: 45, creativity: 30, mental: 50, 
  ...
  { 
    ...
    musicality: 35, technique: 30, stagePresence: 60, creativity: 30, mental: 20, 
    fatigue: 0, stress: 40, affection: 60, personality: '虽然总是把事情搞砸，但依然梦想成为闪闪发光的偶像。', 
    tags: ['冒失', '偶像'], interactionsLeft: 2, 
    composing: 15, lyrics: 30, arrangement: 10, design: 40, 
  ...
  { 
    ...
    musicality: 50, technique: 45, stagePresence: 35, creativity: 55, mental: 35, 
    fatigue: 0, stress: 10, affection: 30, personality: '总是戴着兜帽的神秘少女，声称自己是从2077年穿越回来的。', 
    tags: ['电波', '未来人'], interactionsLeft: 2, 
    composing: 45, lyrics: 20, arrangement: 55, design: 45, 
