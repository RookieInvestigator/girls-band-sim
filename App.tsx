  ...
  return (
    <div className="h-screen bg-[#F8FAFC] font-sans text-slate-900 flex overflow-hidden relative selection:bg-pink-100 selection:text-pink-600">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
          ...
          <header className="shrink-0 z-40 mx-4 mt-4 mb-2 rounded-full bg-white/80 backdrop-blur-xl border border-slate-200/50 shadow-sm flex justify-between items-center px-6 py-3">
              <div className="flex items-center gap-4">
                  ...
                  {/* Desktop Week */}
                  <div className="hidden lg:flex items-center gap-2 font-black text-slate-900 tracking-tighter text-lg">
                      <div className="w-8 h-8 rounded-full bg-slate-900 text-white flex items-center justify-center text-xs shadow-md shadow-slate-200">
                        #{engine.gameState.currentWeek}
                      </div>
                      <span className="text-sm text-slate-500 font-bold uppercase tracking-widest">Week</span>
                  </div>
              </div>
              
              {/* Resources */}
              <div className="flex gap-3">
                  <div className="flex items-center gap-2 text-xs md:text-sm font-bold text-slate-700 bg-slate-100/50 px-4 py-2 rounded-full border border-slate-200/50">
